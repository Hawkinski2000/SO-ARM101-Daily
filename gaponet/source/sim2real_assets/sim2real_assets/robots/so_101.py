...
SO101_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{here}/../usds/so101/SO-ARM101-USD.usd",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        pos=(-0.05, 0.0, 0),
        rot=tuple(euler_angles_to_quat(np.array([0, 0, 90]), degrees=True).tolist()),
...
S0101_NO_CAMERA_CFG.spawn.usd_path = f"{here}/../usds/so101/SO-ARM101-USD-NO-CAMERA.usd"
